    ...
    <form action="/">
      <div>
        <select v-model="selectedState" id="state" name="state">
          ...
          <option v-for="state in stateList" :key="state.rnum" :value="state.code">
            {{ state.name }}
          </option>
        </select>
      </div>
      <div>
        <select v-model="selectedCity" id="city" name="city">
          ...
          <option v-for="city in cityList" :key="city.rnum" :value="city.code">
            {{ city.name }}
          </option>
        </select>
      </div>
      <div class="col-auto">
        <select v-model="selectedType" id="type" name="type">
