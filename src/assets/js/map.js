...
async function searchLocalTrip() {
  ...
  if (localTripData && localTripData["item"]) {
...
function getURL(baseUrl, apiKey, queryParams) {
...
function getStateData() {
  let service = "areaCode1"
  let baseUrl = "https://apis.data.go.kr/B551011/KorService1/" + service;
  let apiKey =
  ...
  let finalUrl = getURL(baseUrl, apiKey, queryParams);
